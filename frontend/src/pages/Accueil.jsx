...
export default function Accueil() {
  ...
  return (
    <main className="flex flex-col items-center gap-10 text-center">
      <section
        className="relative -mx-6 -mt-10 flex w-[calc(100%+3rem)] flex-col items-center gap-6 overflow-hidden px-6 py-24 text-white sm:py-32 rounded-sm"
      ...
      >
        ...
        <div className="relative z-10 space-y-4">
          ...
          <h1 className="max-w-2xl text-white drop-shadow-sm">
            Naviguez, gérez votre flotte <span className="text-teal-300">en toute confiance</span>
          </h1>
      ...
      <div className="grid w-full gap-4 pt-4 text-left sm:grid-cols-12">
        <div className="relative overflow-hidden sm:col-span-7 sm:row-span-2 rounded-2xl bg-gradient-to-br from-ocean-950/90 via-ocean-900/85 to-ocean-700/85 p-8 text-white shadow-sm backdrop-blur-sm">
          <span className="goutte-eau goutte-eau--sombre pointer-events-none absolute -left-3 -top-3 h-9 w-9" aria-hidden="true" />
                  <span className="goutte-eau goutte-eau--sombre pointer-events-none absolute bottom-[4%] right-10 h-12 w-12" style={{ animationDelay: '2.4s' }} aria-hidden="true" />
                  <span className="goutte-eau goutte-eau--sombre pointer-events-none absolute -right-3 -top-3 h-12 w-12" style={{ animationDelay: '2.4s' }} aria-hidden="true" />

          <span className="goutte-eau goutte-eau--sombre pointer-events-none absolute bottom-24 right-56 h-6 w-6" style={{ animationDelay: '1.3s' }} aria-hidden="true" />
          <span className="goutte-eau goutte-eau--sombre pointer-events-none absolute bottom-[8%] left-[6%] h-16 w-16" style={{ animationDelay: '0.2s' }} aria-hidden="true" />
          {/* <span className="goutte-eau goutte-eau--sombre pointer-events-none absolute right-20 top-15 h-5 w-5" style={{ animationDelay: '2.1s' }} aria-hidden="true" /> */}
        ...
        <div className="relative overflow-hidden sm:col-span-5 rounded-2xl border border-ocean-100 bg-white/80 p-6 backdrop-blur-sm">
          ...
          <span className="goutte-eau goutte-eau--claire pointer-events-none absolute left-1 top-3 h-5 w-5" style={{ animationDelay: '2.1s' }} aria-hidden="true" />
        ...
        <div className="relative overflow-hidden sm:col-span-5 rounded-2xl bg-teal-500 p-6 text-white shadow-sm">
